...
class MessageSocketTest : public testing::Test {
 protected:
  ...
  void SetUp() override {
    ...
    auto optional_connection_socket = server_socket_->acceptConnection<ConnectionMessageSocket>();
    if (optional_connection_socket) connection_socket_ = *optional_connection_socket;
  }
